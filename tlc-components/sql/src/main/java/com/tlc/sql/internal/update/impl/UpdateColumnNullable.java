 ...
 * @version 1.0
 */
public class UpdateColumnNullable implements AdvDDLAction
{
    private final ColumnDefinition columnDefinition;
    private final TableDefinition tableDefinition;

    public UpdateColumnNullable(TableDefinition tableDefinition, ColumnDefinition columnDefinition)
    {

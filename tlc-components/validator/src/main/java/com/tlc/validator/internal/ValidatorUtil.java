...
public final class ValidatorUtil
{
    ...
    public static boolean isValidEmail(String email)
    {
        ...
        final int splitPosition = email.lastIndexOf( '@' );
        if (splitPosition < 0)
        {
            return false;
        }
        final String localPart = email.substring( 0, splitPosition );
        final String domainPart = email.substring( splitPosition + 1 );
        ...
        return matcher.matches() && isValidEmailDomainAddress(domainPart);
    }

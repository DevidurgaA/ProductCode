...
public class Currency implements TlcModel {

    @NotNull(groups = {Update.class, Delete.class}, message = "i18n.product.currency.invalid.id")
    private Long id;

    @NotEmpty(groups = {Create.class, Update.class}, message = "i18n.product.currency.invalid.name")
    private String name;
